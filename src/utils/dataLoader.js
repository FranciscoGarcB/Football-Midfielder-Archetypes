...
const DataLoader = (() => {
  ...
  function parseRow(d) {
    return {
      ...
      crosses:            +d.crosses             || 0,
      progressive_passes_per90:  +d.progressive_passes_per90  || 0,
      key_passes_per90:          +d.key_passes_per90           || 0,
      pass_completion_pct:       +d.pass_completion_pct        || 0,
      long_pass_pct:             +d.long_pass_pct              || 0,
      gca_per90:                 +d.gca_per90                  || 0,
      prog_carries_per90:        +d.prog_carries_per90         || 0,
      carries_final_third_per90: +d.carries_final_third_per90  || 0,
      sca_per90:                 +d.sca_per90                  || 0,
      fouls_committed_per90:     +d.fouls_committed_per90      || 0,
