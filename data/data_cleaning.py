...
# 1. Load the Top 5 Leagues dataset
df_top5 = pd.read_csv("raw/player_data/Top5_League_Players_2017to2024_dataset.csv", sep=";", decimal=",")

# 2. Define the mapping from the Top 5 dataset to the Target (Cleaned) layout
col_mapping = {
    'player': 'player',
    'nation_': 'nation',
    'pos_': 'pos',
...
# 3. Exact target columns order based on 'cleaned_2023-24.csv'
target_cols = [
